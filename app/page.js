...
export default function Home() {
  ...
  // Fetch user and access token on mount and auth state change
  // This ensures that the user state is updated whenever the authentication state changes
  ...
  if (user === undefined) {
    return (
      <div className="text-stone-100 text-center text-2xl">Loading...</div>
    );
  }
