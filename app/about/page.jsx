...
<br />
 <br/>
Feel free to check out my other work: <b>
     <br/>
      <br/>
    <a href="https://www.marissalamothe.dev" target="_blank" className="text-stone-100 hover:underline">www.marissalamothe.dev</a></b>
 <br/>
    </p>
          </div>
          <Footer />
