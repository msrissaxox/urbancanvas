...
{/* location, city comment and like */}
    <div className="flex items-center justify-between w-full mb-2">
  {/* Left side: Location icon and city */}
  <div className="flex items-center gap-2">
    ...
    <h5 className="text-xl font-medium leading-tight">City</h5>
  </div>

  {/* Right side: Heart and comment icons */}
